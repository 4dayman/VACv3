                ...
                <div class="calculator_settings">
                    ...
                    <div class="settings_amount">
                        <div class="amount_value">
                            <h4>Loan Amount</h4>
                            <p>$ {{ amountValue.toString().replace(/\B(?=(\d{3})+(?!\d))/g, " ") }}</p>
                        </div>
                    ...
                    <div class="settings_duration">
                        ...
                        <div class="duration_fill">
                            <input class="range" type="range" min="6" max="48" step="1" v-model.number="amountDuration"
                                @change="Priceround">
                            <input class="fill" type="range" min="6" max="48" step="1" v-model.number="amountDuration"
                                @change="Priceround">
                        </div>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            buttons: [
                { slot: 'poor', amountDuration: 12 },
                { slot: 'average', amountDuration: 18 },
                { slot: 'good', amountDuration: 24 }
            ],
            amountValue: this.price,
            amountDuration: 12,
            PriceMonthly: 2500,
            PriceBiWeekly: 1250,
            PriceWeekly: 625,
